...
bb0:
  %t6 = icmp slt i32 1, 5
  br i1 %t6, label %if_then0, label %exit
if_then0:
  %t7 = call float @solution_(ptr %arg0)
  %t8 = load float, ptr %arg1
  %t9 = fsub float %t7, %t8
  store float %t9, ptr %t0
  br label %if_then1
if_then1:
  %t10 = load float, ptr %t0
  %t11 = call float @llvm.fabs.f32(float %t10)
  store float %t11, ptr %t1
  br label %if_then2
if_then2:
  %t12 = load float, ptr %t1
  %t13 = load float, ptr %arg3
  %t14 = fcmp ogt float %t12, %t13
  br i1 %t14, label %if_then3, label %exit
if_then3:
  %t15 = load float, ptr %t1
  store float %t15, ptr %t2
  br label %if_then4
if_then4:
  br label %if_then5
if_then5:
  %t16 = load float, ptr %t2
  %t17 = load float, ptr %arg2
  %t18 = fcmp ogt float %t16, %t17
  br i1 %t18, label %if_then6, label %exit
if_then6:
  %t19 = load i32, ptr %t5
  %t20 = getelementptr [12 x i8], ptr @str19, i32 0, i32 0
  %t21 = getelementptr [7 x i8], ptr @str20, i32 0, i32 0
  %t22 = alloca i32
  store i32 11, ptr %t22
  %t23 = alloca i32
  store i32 11, ptr %t23
  %t24 = alloca ptr, i32 3
  %t25 = getelementptr ptr, ptr %t24, i32 0
  store ptr %t22, ptr %t25
  %t26 = getelementptr ptr, ptr %t24, i32 1
  store ptr %t23, ptr %t26
  %t27 = getelementptr ptr, ptr %t24, i32 2
  store ptr %t20, ptr %t27
  %t28 = getelementptr [4 x i8], ptr @str6, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t19, ptr %t21, ptr %t24, ptr %t28, i32 3, i32 0)
  br label %if_then7
if_then7:
  %t29 = load i32, ptr %t5
  %t30 = getelementptr [13 x i8], ptr @str21, i32 0, i32 0
  %t31 = call float @solution_(ptr %arg0)
  %t32 = fpext float %t31 to double
  %t33 = call ptr @col6forge_fmt_d(i32 15, i32 7, i32 0, i32 0, i32 0, double %t32)
  %t34 = getelementptr [23 x i8], ptr @str15, i32 0, i32 0
  %t35 = alloca i32
  store i32 12, ptr %t35
  %t36 = alloca i32
  store i32 12, ptr %t36
  %t37 = alloca ptr, i32 4
  %t38 = getelementptr ptr, ptr %t37, i32 0
  store ptr %t35, ptr %t38
  %t39 = getelementptr ptr, ptr %t37, i32 1
  store ptr %t36, ptr %t39
  %t40 = getelementptr ptr, ptr %t37, i32 2
  store ptr %t30, ptr %t40
  %t41 = getelementptr ptr, ptr %t37, i32 3
  store ptr %t33, ptr %t41
  %t42 = getelementptr [5 x i8], ptr @str16, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t29, ptr %t34, ptr %t37, ptr %t42, i32 4, i32 0)
  br label %if_then8
if_then8:
  %t43 = load i32, ptr %t5
  %t44 = getelementptr [13 x i8], ptr @str22, i32 0, i32 0
  %t45 = load float, ptr %arg1
  %t46 = fpext float %t45 to double
  %t47 = call ptr @col6forge_fmt_d(i32 15, i32 7, i32 0, i32 0, i32 0, double %t46)
  %t48 = getelementptr [22 x i8], ptr @str23, i32 0, i32 0
  %t49 = alloca i32
  store i32 12, ptr %t49
  %t50 = alloca i32
  store i32 12, ptr %t50
  %t51 = alloca ptr, i32 4
  %t52 = getelementptr ptr, ptr %t51, i32 0
  store ptr %t49, ptr %t52
  %t53 = getelementptr ptr, ptr %t51, i32 1
  store ptr %t50, ptr %t53
  %t54 = getelementptr ptr, ptr %t51, i32 2
  store ptr %t44, ptr %t54
  %t55 = getelementptr ptr, ptr %t51, i32 3
  store ptr %t47, ptr %t55
  %t56 = getelementptr [5 x i8], ptr @str16, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t43, ptr %t48, ptr %t51, ptr %t56, i32 4, i32 0)
  br label %if_then9
if_then9:
  %t57 = load i32, ptr %t5
  %t58 = getelementptr [10 x i8], ptr @str24, i32 0, i32 0
  %t59 = load float, ptr %t1
  %t60 = fpext float %t59 to double
  %t61 = call ptr @col6forge_fmt_d(i32 15, i32 7, i32 0, i32 0, i32 0, double %t60)
  %t62 = getelementptr [22 x i8], ptr @str23, i32 0, i32 0
  %t63 = alloca i32
  store i32 9, ptr %t63
  %t64 = alloca i32
  store i32 9, ptr %t64
  %t65 = alloca ptr, i32 4
  %t66 = getelementptr ptr, ptr %t65, i32 0
  store ptr %t63, ptr %t66
  %t67 = getelementptr ptr, ptr %t65, i32 1
  store ptr %t64, ptr %t67
  %t68 = getelementptr ptr, ptr %t65, i32 2
  store ptr %t58, ptr %t68
  %t69 = getelementptr ptr, ptr %t65, i32 3
  store ptr %t61, ptr %t69
  %t70 = getelementptr [5 x i8], ptr @str16, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t57, ptr %t62, ptr %t65, ptr %t70, i32 4, i32 0)
  br label %if_then10
if_then10:
  %t71 = load i32, ptr %t5
  %t72 = getelementptr [10 x i8], ptr @str25, i32 0, i32 0
  %t73 = load float, ptr %t2
  %t74 = fpext float %t73 to double
  %t75 = call ptr @col6forge_fmt_d(i32 15, i32 7, i32 0, i32 0, i32 0, double %t74)
  %t76 = getelementptr [22 x i8], ptr @str23, i32 0, i32 0
  %t77 = alloca i32
  store i32 9, ptr %t77
  %t78 = alloca i32
  store i32 9, ptr %t78
  %t79 = alloca ptr, i32 4
  ...
  store ptr %t72, ptr %t82
  %t83 = getelementptr ptr, ptr %t79, i32 3
  store ptr %t75, ptr %t83
  %t84 = getelementptr [5 x i8], ptr @str16, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t71, ptr %t76, ptr %t79, ptr %t84, i32 4, i32 0)
  br label %if_then11
if_then11:
  ret void
exit:

...
bb1:
  br label %bb2
bb2:
  %t10 = fsub float 0.0, 1.0e0
  store float %t10, ptr %t4
  br label %bb3
bb3:
  %t11 = alloca i32
  store i32 1, ptr %t11
  %t12 = call float @dpmpar_(ptr %t11)
...
bb4:
  ...
  call void @hybrd1_(ptr %t8, ptr %t14, ptr %t4, ptr %t5, ptr %t2, ptr %t1, ptr %t6, ptr %t15)
  br label %bb5
bb5:
  %t16 = alloca i32
  store i32 9, ptr %t16

...
bb37:
  ...
  call i32 @col6forge_write_v(i32 %t74, ptr %t78, ptr %t82, ptr %t86, i32 3, i32 0)
  br label %L3311
L3311:
  br label %bb39
bb39:
...
bb91:
  ...
  call i32 @col6forge_write_v(i32 %t218, ptr %t222, ptr %t226, ptr %t230, i32 3, i32 0)
  br label %L3341
L3341:
  br label %bb93
bb93:
...
bb235:
  ...
  call i32 @col6forge_write_v(i32 %t602, ptr %t606, ptr %t610, ptr %t614, i32 3, i32 0)
  br label %L3421
L3421:
  br label %bb237
bb237:
...
bb289:
  ...
  call i32 @col6forge_write_v(i32 %t746, ptr %t750, ptr %t754, ptr %t758, i32 3, i32 0)
  br label %L3451
L3451:
  br label %bb291
bb291:
...
bb325:
  ...
  call i32 @col6forge_write_v(i32 %t842, ptr %t846, ptr %t850, ptr %t854, i32 3, i32 0)
  br label %L3471
L3471:
  br label %bb327
bb327:
...
bb379:
  ...
  call i32 @col6forge_write_v(i32 %t984, ptr %t988, ptr %t992, ptr %t996, i32 3, i32 0)
  br label %L3501
L3501:
  br label %bb381
bb381:
...
bb397:
  ...
  call i32 @col6forge_write_v(i32 %t1032, ptr %t1036, ptr %t1040, ptr %t1044, i32 3, i32 0)
  br label %L3511
L3511:
  br label %bb399
bb399:
...
bb415:
  ...
  call i32 @col6forge_write_v(i32 %t1080, ptr %t1084, ptr %t1088, ptr %t1092, i32 3, i32 0)
  br label %L3521
L3521:
  br label %bb417
bb417:
...
bb443:
  ...
  call i32 @col6forge_write_v(i32 %t1149, ptr %t1151, ptr %t1153, ptr %t1155, i32 1, i32 0)
  br label %bb444
bb444:
...
bb451:
  ...
  call i32 @col6forge_write_v(i32 %t1174, ptr %t1178, ptr %t1182, ptr %t1186, i32 3, i32 0)
  br label %L3541
L3541:
  br label %bb453
bb453:
...
bb487:
  ...
  call i32 @col6forge_write_v(i32 %t1272, ptr %t1276, ptr %t1280, ptr %t1284, i32 3, i32 0)
  br label %L3561
L3561:
  br label %bb489
bb489:
...
bb505:
  ...
  call i32 @col6forge_write_v(i32 %t1320, ptr %t1324, ptr %t1328, ptr %t1332, i32 3, i32 0)
  br label %L3571
L3571:
  br label %bb507
bb507:
...
bb523:
  ...
  call i32 @col6forge_write_v(i32 %t1368, ptr %t1372, ptr %t1376, ptr %t1380, i32 3, i32 0)
  br label %L3581
L3581:
  br label %bb525
bb525:
...
bb551:
  ...
  call i32 @col6forge_write_v(i32 %t1439, ptr %t1441, ptr %t1443, ptr %t1445, i32 1, i32 0)
  br label %bb552
bb552:
...
bb559:
  ...
  call i32 @col6forge_write_v(i32 %t1464, ptr %t1468, ptr %t1472, ptr %t1476, i32 3, i32 0)
  br label %L3601
L3601:
  br label %L99999
L99999:
...
bb569:
  ...
  call i32 @col6forge_write_v(i32 %t1496, ptr %t1498, ptr %t1500, ptr %t1502, i32 1, i32 0)
  br label %bb570
bb570:
  ...
  call i32 @col6forge_write_v(i32 %t1503, ptr %t1505, ptr %t1507, ptr %t1509, i32 1, i32 0)
  br label %bb571
bb571:
  ret void
L90000:

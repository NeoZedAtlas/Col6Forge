...
bb65:
  ...
  %t834 = load i32, ptr %t28
  %t835 = sext i32 1 to i64
  %t836 = sub i64 %t835, 1
  %t837 = mul i64 %t836, 1
  %t838 = add i64 0, %t837
  %t839 = getelementptr float, ptr %t3, i64 %t838
  %t840 = sext i32 2 to i64
  %t841 = sub i64 %t840, 1
  %t842 = mul i64 %t841, 1
  %t843 = add i64 0, %t842
  %t844 = getelementptr float, ptr %t3, i64 %t843
  %t845 = sext i32 3 to i64
  %t846 = sub i64 %t845, 1
  %t847 = mul i64 %t846, 1
  %t848 = add i64 0, %t847
  %t849 = getelementptr float, ptr %t3, i64 %t848
  %t850 = sext i32 4 to i64
  %t851 = sub i64 %t850, 1
  %t852 = mul i64 %t851, 1
  %t853 = add i64 0, %t852
  ...
  %t857 = mul i64 %t856, 1
  %t858 = add i64 0, %t857
  %t859 = getelementptr float, ptr %t3, i64 %t858
  switch i32 %t834, label %fmt_default49 [
...
bb69:
  ...
  %t1153 = getelementptr float, ptr %t3, i64 %t1152
  %t1154 = sext i32 5 to i64
  %t1155 = sub i64 %t1154, 1
  %t1156 = mul i64 %t1155, 1
  %t1157 = add i64 0, %t1156
  %t1158 = getelementptr float, ptr %t3, i64 %t1157
  %t1159 = load float, ptr %t1158
  switch i32 %t1147, label %fmt_default99 [
...
fmt_case52:
  ...
  br label %fmt_done98
fmt_case53:
  %t1179 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case54:
  %t1188 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case55:
  %t1197 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case56:
  %t1206 = fpext float %t1159 to double
...
fmt_case57:
  ...
  br label %fmt_done98
fmt_case58:
  %t1224 = sitofp i32 %t1148 to double
  %t1225 = call ptr @col6forge_fmt_f(i32 5, i32 2, i32 0, double %t1224)
  %t1226 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case59:
  %t1233 = fpext float %t1159 to double
...
fmt_case65:
  ...
  br label %fmt_done98
fmt_case66:
  %t1248 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case67:
  %t1257 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case68:
  %t1266 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case69:
  %t1275 = fpext float %t1159 to double
...
fmt_case70:
  ...
  br label %fmt_done98
fmt_case71:
  %t1293 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case72:
  %t1302 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case73:
  %t1311 = call ptr @col6forge_fmt_i(i32 21, i32 0, i32 0, i32 %t1148)
  %t1312 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case74:
  %t1319 = call ptr @col6forge_fmt_i(i32 21, i32 0, i32 0, i32 %t1148)
  %t1320 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case75:
  %t1327 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case76:
  %t1336 = fpext float %t1159 to double
...
fmt_case78:
  ...
  br label %fmt_done98
fmt_case79:
  %t1363 = call ptr @col6forge_fmt_i(i32 31, i32 0, i32 0, i32 %t1148)
  %t1364 = fpext float %t1159 to double
...
fmt_case83:
  ...
  br label %fmt_done98
fmt_case84:
  %t1375 = call ptr @col6forge_fmt_i(i32 13, i32 0, i32 0, i32 %t1148)
  %t1376 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case85:
  %t1383 = call ptr @col6forge_fmt_i(i32 5, i32 0, i32 0, i32 %t1148)
  %t1384 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case86:
  %t1391 = call ptr @col6forge_fmt_i(i32 17, i32 0, i32 0, i32 %t1148)
  %t1392 = fpext float %t1159 to double
...
fmt_case89:
  ...
  br label %fmt_done98
fmt_case90:
  %t1410 = call ptr @col6forge_fmt_i(i32 5, i32 0, i32 0, i32 %t1148)
  %t1411 = fpext float %t1159 to double
  ...
  br label %fmt_done98
fmt_case91:
  %t1418 = call ptr @col6forge_fmt_i(i32 13, i32 0, i32 0, i32 %t1148)
  %t1419 = fpext float %t1159 to double
...
bb89:
  ...
  %t1789 = load i32, ptr %t20
  %t1790 = load i32, ptr %t19
  %t1791 = getelementptr [49 x i8], ptr @str125, i32 0, i32 0
  %t1792 = alloca i32, i32 2
  ...
  %t1795 = alloca ptr, i32 2
  %t1796 = getelementptr ptr, ptr %t1795, i32 0
  store ptr %t1793, ptr %t1796
  %t1797 = getelementptr ptr, ptr %t1795, i32 1
  store ptr %t1794, ptr %t1797
  %t1798 = getelementptr [3 x i8], ptr @str89, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t1787, ptr %t1791, ptr %t1795, ptr %t1798, i32 2, i32 0)
  br label %bb90
bb90:
  %t1799 = load i32, ptr %t23
  %t1800 = getelementptr [49 x i8], ptr @str136, i32 0, i32 0
  %t1801 = alloca i32, i32 4
  ...
  %t1805 = getelementptr i32, ptr %t1801, i32 3
  store i32 5, ptr %t1805
  %t1806 = alloca ptr, i32 6
  %t1807 = getelementptr ptr, ptr %t1806, i32 0
  store ptr %t1802, ptr %t1807
  %t1808 = getelementptr ptr, ptr %t1806, i32 1
  store ptr %t1803, ptr %t1808
  %t1809 = getelementptr ptr, ptr %t1806, i32 2
  store ptr %t8, ptr %t1809
  %t1810 = getelementptr ptr, ptr %t1806, i32 3
  store ptr %t1804, ptr %t1810
  %t1811 = getelementptr ptr, ptr %t1806, i32 4
  store ptr %t1805, ptr %t1811
  %t1812 = getelementptr ptr, ptr %t1806, i32 5
  store ptr %t8, ptr %t1812
  %t1813 = getelementptr [7 x i8], ptr @str4, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t1799, ptr %t1800, ptr %t1806, ptr %t1813, i32 6, i32 0)
  br label %bb91
bb91:
  %t1814 = load i32, ptr %t23
  %t1815 = getelementptr [44 x i8], ptr @str137, i32 0, i32 0
  %t1816 = alloca i32, i32 8
  %t1817 = getelementptr i32, ptr %t1816, i32 0
  store i32 13, ptr %t1817
  %t1818 = getelementptr i32, ptr %t1816, i32 1
  store i32 13, ptr %t1818
  %t1819 = getelementptr i32, ptr %t1816, i32 2
  store i32 20, ptr %t1819
  %t1820 = getelementptr i32, ptr %t1816, i32 3
  store i32 20, ptr %t1820
  %t1821 = getelementptr i32, ptr %t1816, i32 4
  store i32 10, ptr %t1821
  %t1822 = getelementptr i32, ptr %t1816, i32 5
  store i32 10, ptr %t1822
  %t1823 = getelementptr i32, ptr %t1816, i32 6
  store i32 13, ptr %t1823
  %t1824 = getelementptr i32, ptr %t1816, i32 7
  store i32 13, ptr %t1824
  %t1825 = alloca ptr, i32 12

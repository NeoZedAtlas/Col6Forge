...
bb26:
  ...
  br label %L12
L12:
  %t254 = call i32 @sn515_(ptr %t22)
  %t255 = icmp eq i32 %t254, 1
  br i1 %t255, label %L13, label %altret0
altret0:
  %t256 = icmp eq i32 %t254, 2
  br i1 %t256, label %L14, label %bb31
bb31:
...
L40010:
  ...
  br i1 %t265, label %L20010, label %arith_if_zero1
arith_if_zero1:
...
bb40:
  ...
  %t271 = getelementptr [19 x i8], ptr @str12, i32 0, i32 0
  ...
  %t276 = getelementptr [2 x i8], ptr @str11, i32 0, i32 0
...
bb43:
  ...
  %t282 = load i32, ptr %t21
  %t283 = getelementptr [79 x i8], ptr @str13, i32 0, i32 0
  ...
  %t292 = getelementptr [4 x i8], ptr @str14, i32 0, i32 0
...
bb45:
  ...
  %t294 = call i32 @sn516_(ptr %t293, ptr %t22)
  %t295 = icmp eq i32 %t294, 1
  br i1 %t295, label %L24, label %L22
L22:
  %t296 = load i32, ptr %t20
  %t297 = load i32, ptr %t22
  %t298 = sub i32 %t296, %t297
  store i32 %t298, ptr %t20
  br label %bb50
bb50:
  br label %L25
L23:
...
bb52:
  ...
  %t302 = alloca i32
  store i32 4, ptr %t302
  %t303 = call i32 @sn516_(ptr %t302, ptr %t22)
  %t304 = icmp eq i32 %t303, 1
  br i1 %t304, label %L22, label %bb54
bb54:
  %t305 = load i32, ptr %t20
  %t306 = load i32, ptr %t22
  %t307 = add i32 %t305, %t306
  store i32 %t307, ptr %t20
  br label %L24
L24:
  br label %bb56
bb56:
  ...
  %t311 = alloca i32
  store i32 3, ptr %t311
  %t312 = call i32 @sn516_(ptr %t311, ptr %t22)
  %t313 = icmp eq i32 %t312, 1
  br i1 %t313, label %L23, label %bb58
bb58:
  %t314 = load i32, ptr %t20
  %t315 = load i32, ptr %t22
  %t316 = add i32 %t314, %t315
  store i32 %t316, ptr %t20
  br label %L25
L25:
  br label %L40020
L40020:
...
bb62:
  ...
  %t325 = getelementptr [19 x i8], ptr @str12, i32 0, i32 0
  ...
  %t330 = getelementptr [2 x i8], ptr @str11, i32 0, i32 0
...
bb65:
  ...
  %t337 = getelementptr [79 x i8], ptr @str13, i32 0, i32 0
  ...
  %t346 = getelementptr [4 x i8], ptr @str14, i32 0, i32 0
...
bb72:
  ...
  %t370 = getelementptr [40 x i8], ptr @str16, i32 0, i32 0
...
bb75:
  ...
  %t395 = getelementptr [49 x i8], ptr @str19, i32 0, i32 0
  ...
  %t402 = getelementptr [3 x i8], ptr @str20, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t392, ptr %t395, ptr %t399, ptr %t402, i32 2, i32 0)
  call void @free(ptr %t396)
  call void @free(ptr %t399)
  br label %bb76
bb76:
  %t403 = load i32, ptr %t18
  %t404 = getelementptr [49 x i8], ptr @str21, i32 0, i32 0
  %t405 = call ptr @malloc(i64 16)
  %t406 = getelementptr i32, ptr %t405, i32 0
  store i32 5, ptr %t406
  ...
  store ptr %t3, ptr %t416
  %t417 = getelementptr [7 x i8], ptr @str4, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t403, ptr %t404, ptr %t410, ptr %t417, i32 6, i32 0)
  call void @free(ptr %t405)
  call void @free(ptr %t410)
  br label %bb77
bb77:
  %t418 = load i32, ptr %t18
  %t419 = getelementptr [44 x i8], ptr @str22, i32 0, i32 0
  %t420 = call ptr @malloc(i64 32)
  %t421 = getelementptr i32, ptr %t420, i32 0
  store i32 13, ptr %t421
  %t422 = getelementptr i32, ptr %t420, i32 1
  store i32 13, ptr %t422
  %t423 = getelementptr i32, ptr %t420, i32 2
  store i32 20, ptr %t423
  %t424 = getelementptr i32, ptr %t420, i32 3
  store i32 20, ptr %t424
  %t425 = getelementptr i32, ptr %t420, i32 4
  store i32 10, ptr %t425
  %t426 = getelementptr i32, ptr %t420, i32 5
  store i32 10, ptr %t426
  %t427 = getelementptr i32, ptr %t420, i32 6
  store i32 13, ptr %t427
  %t428 = getelementptr i32, ptr %t420, i32 7
  store i32 13, ptr %t428
  %t429 = call ptr @malloc(i64 96)
  %t430 = getelementptr ptr, ptr %t429, i32 0
  store ptr %t421, ptr %t430
  %t431 = getelementptr ptr, ptr %t429, i32 1
  store ptr %t422, ptr %t431
  %t432 = getelementptr ptr, ptr %t429, i32 2
  store ptr %t7, ptr %t432
  %t433 = getelementptr ptr, ptr %t429, i32 3
  store ptr %t423, ptr %t433
  %t434 = getelementptr ptr, ptr %t429, i32 4
  store ptr %t424, ptr %t434
  ...
  %t441 = getelementptr ptr, ptr %t429, i32 11
  store ptr %t9, ptr %t441
  %t442 = getelementptr [13 x i8], ptr @str23, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t418, ptr %t419, ptr %t429, ptr %t442, i32 12, i32 0)
  call void @free(ptr %t420)
  call void @free(ptr %t429)
  br label %bb78
bb78:
  %t443 = load i32, ptr %t18
  %t444 = getelementptr [79 x i8], ptr @str24, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t443, ptr %t444, ptr null, ptr null, i32 0, i32 0)
  br label %L90001
L90001:
  br label %L90000
L90000:

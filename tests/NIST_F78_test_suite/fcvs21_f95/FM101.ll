...
bb72:
  ...
  br i1 %t371, label %L20190, label %arith_if_zero17
arith_if_zero17:
  %t372 = icmp eq i32 %t370, 0
  br i1 %t372, label %L10190, label %L20190
L10190:
...
bb84:
  ...
  %t443 = getelementptr [82 x i8], ptr @str11, i32 0, i32 0
  ...
  call i32 @f77_formatted_read_core(i32 %t415, ptr %t443, ptr %t444, ptr %t472, i32 27, i32 0)
  br label %L192
L192:
  br label %do_inc23
do_inc23:
...
bb88:
  ...
  br i1 %t486, label %L30190, label %arith_if_zero24
arith_if_zero24:
  %t487 = icmp eq i32 %t485, 0
  br i1 %t487, label %L194, label %L30190
L30190:
...
bb93:
  ...
  br i1 %t498, label %L30200, label %arith_if_zero25
arith_if_zero25:
  %t499 = icmp eq i32 %t497, 0
  br i1 %t499, label %L200, label %L30200
L200:
  br label %bb95
bb95:
  ...
  %t528 = getelementptr [82 x i8], ptr @str11, i32 0, i32 0
  ...
  call i32 @f77_formatted_read_core(i32 %t500, ptr %t528, ptr %t529, ptr %t557, i32 27, i32 0)
  br label %bb96
bb96:
...
bb100:
  ...
  br i1 %t574, label %L40200, label %arith_if_zero26
arith_if_zero26:
  %t575 = icmp eq i32 %t573, 0
  br i1 %t575, label %L211, label %L40200
L40200:
  %t576 = load i32, ptr %t42
  %t577 = sub i32 %t576, 30
  %t578 = icmp slt i32 %t577, 0
  br i1 %t578, label %L20200, label %arith_if_zero27
arith_if_zero27:
  %t579 = icmp eq i32 %t577, 0
  br i1 %t579, label %L10200, label %L20200
L10200:
...
bb110:
  ...
  br i1 %t605, label %L30210, label %arith_if_zero28
arith_if_zero28:
  %t606 = icmp eq i32 %t604, 0
  br i1 %t606, label %L210, label %L30210
L210:
  br label %bb112
bb112:
  ...
  %t635 = getelementptr [82 x i8], ptr @str11, i32 0, i32 0
  ...
  call i32 @f77_formatted_read_core(i32 %t607, ptr %t635, ptr %t636, ptr %t664, i32 27, i32 0)
  br label %bb113
bb113:
...
bb117:
  ...
  br i1 %t681, label %L40210, label %arith_if_zero29
arith_if_zero29:
  %t682 = icmp eq i32 %t680, 0
  br i1 %t682, label %L221, label %L40210
L40210:
  %t683 = load i32, ptr %t42
  %t684 = sub i32 %t683, 31
  %t685 = icmp slt i32 %t684, 0
  br i1 %t685, label %L20210, label %arith_if_zero30
arith_if_zero30:
  %t686 = icmp eq i32 %t684, 0
  br i1 %t686, label %L10210, label %L20210
L10210:
...
bb124:
  ...
  call i32 @f77_write_v(i32 %t698, ptr %t702, ptr %t706, ptr %t710, i32 3, i32 0)
  br label %L221
L221:
  br label %bb126
bb126:
...
bb127:
  ...
  br i1 %t712, label %L30220, label %arith_if_zero31
arith_if_zero31:
  %t713 = icmp eq i32 %t711, 0
  br i1 %t713, label %L220, label %L30220
L220:
  br label %bb129
bb129:
...
bb133:
  ...
  br i1 %t730, label %L40220, label %arith_if_zero32
arith_if_zero32:
  %t731 = icmp eq i32 %t729, 0
  br i1 %t731, label %L231, label %L40220
L40220:
  %t732 = load i32, ptr %t42
  %t733 = sub i32 %t732, 9999
  %t734 = icmp slt i32 %t733, 0
  br i1 %t734, label %L20220, label %arith_if_zero33
arith_if_zero33:
  %t735 = icmp eq i32 %t733, 0
  br i1 %t735, label %L10220, label %L20220
L10220:
...
bb143:
  ...
  call i32 @f77_write_v(i32 %t760, ptr %t761, ptr null, ptr null, i32 0, i32 0)
  br label %bb144
bb144:
  %t762 = load i32, ptr %t5
  %t763 = getelementptr [54 x i8], ptr @str7, i32 0, i32 0
  call i32 @f77_write_v(i32 %t762, ptr %t763, ptr null, ptr null, i32 0, i32 0)
  br label %bb145
bb145:

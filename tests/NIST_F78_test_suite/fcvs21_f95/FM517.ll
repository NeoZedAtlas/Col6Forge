...
bb26:
  ...
  store i32 3, ptr %t21
  store i32 2, ptr %t22
  %t351 = call i32 @sn518_(ptr %t22)
  %t352 = icmp eq i32 %t351, 1
  br i1 %t352, label %L12, label %altret66
altret66:
  %t353 = icmp eq i32 %t351, 2
  br i1 %t353, label %L13, label %bb31
bb31:
  store i32 1, ptr %t20
  br label %L14
L12:
...
bb46:
  ...
  store i32 5, ptr %t21
  %t384 = alloca i32
  store i32 7, ptr %t384
  %t385 = call i32 @sn519_(ptr %t384)
  %t386 = icmp eq i32 %t385, 1
  br i1 %t386, label %L22, label %altret68
altret68:
  %t387 = icmp eq i32 %t385, 2
  br i1 %t387, label %L23, label %bb50
bb50:
  store i32 1, ptr %t20
  br label %L24
L22:
...
L40020:
  ...
  br i1 %t390, label %L20020, label %arith_if_zero69
arith_if_zero69:
  %t391 = icmp eq i32 %t389, 0
  br i1 %t391, label %L10020, label %L20020
L10020:
...
bb60:
  ...
  %t401 = getelementptr [2 x i8], ptr @str11, i32 0, i32 0
...
bb63:
  ...
  %t408 = getelementptr [79 x i8], ptr @str13, i32 0, i32 0
...
bb65:
  ...
  store i32 0, ptr %t20
  %t418 = sub i32 0, 2
  store i32 %t418, ptr %t21
  %t419 = sub i32 0, 3
  %t420 = alloca i32
  store i32 %t419, ptr %t420
  %t421 = call i32 @sn518_(ptr %t420)
  %t422 = icmp eq i32 %t421, 1
  br i1 %t422, label %L32, label %altret70
altret70:
  %t423 = icmp eq i32 %t421, 2
  br i1 %t423, label %L33, label %bb69
bb69:
  %t424 = sub i32 0, 2
...
L40030:
  ...
  br i1 %t429, label %L20030, label %arith_if_zero71
arith_if_zero71:
  %t430 = icmp eq i32 %t428, 0
  br i1 %t430, label %L10030, label %L20030
L10030:
...
bb79:
  ...
  %t435 = getelementptr [19 x i8], ptr @str12, i32 0, i32 0
  ...
  %t440 = getelementptr [2 x i8], ptr @str11, i32 0, i32 0
...
bb82:
  ...
  %t447 = getelementptr [79 x i8], ptr @str13, i32 0, i32 0
...
bb84:
  ...
  %t458 = call i32 @sn518_(ptr %t457)
  %t459 = icmp eq i32 %t458, 1
  br i1 %t459, label %L42, label %altret72
altret72:
  %t460 = icmp eq i32 %t458, 2
  br i1 %t460, label %L43, label %bb88
bb88:
  store i32 7, ptr %t20
  br label %L44
L42:
...
L40040:
  ...
  br i1 %t463, label %L20040, label %arith_if_zero73
arith_if_zero73:
  %t464 = icmp eq i32 %t462, 0
  br i1 %t464, label %L10040, label %L20040
L10040:
...
bb101:
  ...
  %t480 = load i32, ptr %t21
  %t481 = getelementptr [79 x i8], ptr @str13, i32 0, i32 0
...
bb103:
  ...
  store i32 0, ptr %t20
  %t491 = sub i32 0, 10
  store i32 %t491, ptr %t21
  %t492 = alloca i32
  store i32 9, ptr %t492
  %t493 = call i32 @en872_(ptr %t492)
  %t494 = icmp eq i32 %t493, 1
  br i1 %t494, label %L52, label %altret74
altret74:
  %t495 = icmp eq i32 %t493, 2
  br i1 %t495, label %L53, label %bb107
bb107:
  %t496 = sub i32 0, 10
...
L40050:
  ...
  %t498 = add i32 %t497, 10
  %t499 = icmp slt i32 %t498, 0
  br i1 %t499, label %L20050, label %arith_if_zero75
arith_if_zero75:
  %t500 = icmp eq i32 %t498, 0
  br i1 %t500, label %L10050, label %L20050
L10050:
...
bb120:
  ...
  %t517 = getelementptr [79 x i8], ptr @str13, i32 0, i32 0
  ...
  %t526 = getelementptr [4 x i8], ptr @str14, i32 0, i32 0
...
bb128:
  ...
  %t558 = getelementptr [41 x i8], ptr @str17, i32 0, i32 0
...
bb130:
  ...
  %t576 = getelementptr [49 x i8], ptr @str19, i32 0, i32 0
...
bb131:
  ...
  %t585 = getelementptr [49 x i8], ptr @str21, i32 0, i32 0
...
bb132:
  ...
  %t600 = getelementptr [44 x i8], ptr @str22, i32 0, i32 0
  ...
  store ptr %t9, ptr %t622
  %t623 = getelementptr [13 x i8], ptr @str23, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t599, ptr %t600, ptr %t610, ptr %t623, i32 12, i32 0)
  br label %bb133
bb133:
  %t624 = load i32, ptr %t18
  %t625 = getelementptr [79 x i8], ptr @str24, i32 0, i32 0

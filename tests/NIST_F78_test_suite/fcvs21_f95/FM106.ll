...
bb57:
  ...
  %t127 = call ptr @col6forge_fmt_e(i32 8, i32 1, i32 0, i32 0, i32 0, double %t126)
  ...
  %t131 = call ptr @col6forge_fmt_e(i32 9, i32 2, i32 0, i32 0, i32 0, double %t130)
  ...
  %t137 = call ptr @col6forge_fmt_e(i32 10, i32 3, i32 0, i32 0, i32 0, double %t136)
  ...
  %t166 = getelementptr [130 x i8], ptr @str9, i32 0, i32 0
...
bb59:
  ...
  %t207 = getelementptr [56 x i8], ptr @str11, i32 0, i32 0
...
bb61:
  ...
  call void @col6forge_set_runtime_source_context(ptr %t211, i32 199, i32 7)
...
bb72:
  ...
  br i1 %t377, label %L21030, label %arith_if_zero29
arith_if_zero29:
  %t378 = icmp eq i32 %t376, 0
  br i1 %t378, label %L11030, label %L21030
L11030:
...
bb84:
  ...
  call void @col6forge_set_runtime_source_context(ptr %t422, i32 239, i32 7)
...
bb88:
  ...
  br i1 %t487, label %L31030, label %arith_if_zero39
arith_if_zero39:
  %t488 = icmp eq i32 %t486, 0
  br i1 %t488, label %L1035, label %L31030
L31030:
...
bb92:
  ...
  br i1 %t500, label %L31110, label %arith_if_zero40
arith_if_zero40:
  %t501 = icmp eq i32 %t499, 0
  br i1 %t501, label %L1110, label %L31110
L1110:
  br label %bb95
bb95:
  %t502 = load i32, ptr %t10
  %t503 = getelementptr [6 x i8], ptr @str12, i32 0, i32 0
  call void @col6forge_set_runtime_source_context(ptr %t503, i32 257, i32 7)
...
bb100:
  ...
  br i1 %t578, label %L41110, label %arith_if_zero41
arith_if_zero41:
  %t579 = icmp eq i32 %t577, 0
  br i1 %t579, label %L1121, label %L41110
L41110:
  %t580 = load i32, ptr %t42
  %t581 = sub i32 %t580, 30
  %t582 = icmp slt i32 %t581, 0
  br i1 %t582, label %L21110, label %arith_if_zero42
arith_if_zero42:
  %t583 = icmp eq i32 %t581, 0
  br i1 %t583, label %L11110, label %L21110
L11110:
...
bb109:
  ...
  br i1 %t611, label %L31120, label %arith_if_zero43
arith_if_zero43:
  %t612 = icmp eq i32 %t610, 0
  br i1 %t612, label %L1120, label %L31120
L1120:
  br label %bb112
bb112:
  %t613 = load i32, ptr %t10
  %t614 = getelementptr [6 x i8], ptr @str12, i32 0, i32 0
  call void @col6forge_set_runtime_source_context(ptr %t614, i32 278, i32 7)
...
bb117:
  ...
  br i1 %t689, label %L41120, label %arith_if_zero44
arith_if_zero44:
  %t690 = icmp eq i32 %t688, 0
  br i1 %t690, label %L1131, label %L41120
L41120:
  %t691 = load i32, ptr %t42
  %t692 = sub i32 %t691, 31
  %t693 = icmp slt i32 %t692, 0
  br i1 %t693, label %L21120, label %arith_if_zero45
arith_if_zero45:
  %t694 = icmp eq i32 %t692, 0
  br i1 %t694, label %L11120, label %L21120
L11120:
...
bb126:
  ...
  br i1 %t722, label %L31130, label %arith_if_zero46
arith_if_zero46:
  %t723 = icmp eq i32 %t721, 0
  br i1 %t723, label %L1130, label %L31130
L1130:
  br label %bb129
bb129:
...
bb133:
  ...
  br i1 %t741, label %L41130, label %arith_if_zero47
arith_if_zero47:
  %t742 = icmp eq i32 %t740, 0
  br i1 %t742, label %L1141, label %L41130
L41130:
  %t743 = load i32, ptr %t42
  %t744 = sub i32 %t743, 9999
  %t745 = icmp slt i32 %t744, 0
  br i1 %t745, label %L21130, label %arith_if_zero48
arith_if_zero48:
  %t746 = icmp eq i32 %t744, 0
  br i1 %t746, label %L11130, label %L21130
L11130:
...
@str9 = private unnamed_addr constant [130 x i8] c"%3d%2d%2d%3d%3d%3d%4d   %s%s  %s%s%s  %s\0A                        %s%s%s    %s%s\0A %s%s%s  %s%s\0A                          %s%s%s%s\0A\00", align 1
...
@str20 = private unnamed_addr constant [43 x i8] c"                     END OF PROGRAM FM106\0A\00", align 1

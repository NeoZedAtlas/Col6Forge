...
bb52:
  ...
  call i32 @f77_write_v(i32 %t160, ptr %t670, ptr %t931, ptr %t1192, i32 260, i32 0)
  br label %L872
L872:
  br label %do_inc9
do_inc9:
...
bb55:
  ...
  call void @f77_rewind(i32 %t1200)
  br label %bb56
bb56:
...
bb59:
  ...
  call i32 @f77_formatted_read_core(i32 %t1214, ptr %t1215, ptr %t1216, ptr %t1227, i32 10, i32 0)
  br label %bb60
bb60:

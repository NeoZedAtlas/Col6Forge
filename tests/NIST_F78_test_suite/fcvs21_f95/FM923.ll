...
bb440:
  ...
  %t2310 = load i32, ptr %t50
  %t2311 = getelementptr [37 x i8], ptr @str102, i32 0, i32 0
  %t2312 = alloca i32, i32 2
  ...
  %t2318 = getelementptr [3 x i8], ptr @str101, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2307, ptr %t2311, ptr %t2315, ptr %t2318, i32 2, i32 0)
  br label %L70281
L70281:
  br label %bb442
bb442:
  %t2319 = load i32, ptr %t41
  %t2320 = getelementptr [41 x i8], ptr @str103, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2319, ptr %t2320, ptr null, ptr null, i32 0, i32 0)
  br label %L281
L281:
  br label %bb444
bb444:
  %t2321 = load i32, ptr %t31
  %t2322 = load i32, ptr %t32
  %t2323 = add i32 %t2321, %t2322
  %t2324 = load i32, ptr %t33
  %t2325 = add i32 %t2323, %t2324
  %t2326 = load i32, ptr %t34
  %t2327 = add i32 %t2325, %t2326
  store i32 %t2327, ptr %t36
  %t2328 = load i32, ptr %t39
  %t2329 = getelementptr [3 x i8], ptr @str8, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2328, ptr %t2329, ptr null, ptr null, i32 0, i32 0)
  br label %bb446
bb446:
  %t2330 = load i32, ptr %t39
  %t2331 = getelementptr [82 x i8], ptr @str10, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2330, ptr %t2331, ptr null, ptr null, i32 0, i32 0)
  br label %bb447
bb447:
  %t2332 = load i32, ptr %t39
  %t2333 = getelementptr [3 x i8], ptr @str8, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2332, ptr %t2333, ptr null, ptr null, i32 0, i32 0)
  br label %bb448
bb448:
  %t2334 = load i32, ptr %t39
  %t2335 = load i32, ptr %t31
  %t2336 = getelementptr [40 x i8], ptr @str104, i32 0, i32 0
  ...
  br label %bb449
bb449:
  %t2342 = load i32, ptr %t39
  %t2343 = load i32, ptr %t32
  %t2344 = getelementptr [40 x i8], ptr @str105, i32 0, i32 0
  ...
  %t2349 = getelementptr [2 x i8], ptr @str12, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2342, ptr %t2344, ptr %t2347, ptr %t2349, i32 1, i32 0)
  br label %bb450
bb450:
  %t2350 = load i32, ptr %t39
  %t2351 = load i32, ptr %t33
  %t2352 = getelementptr [41 x i8], ptr @str106, i32 0, i32 0
...
bb451:
  ...
  %t2360 = getelementptr [52 x i8], ptr @str107, i32 0, i32 0
  ...
  %t2365 = getelementptr [2 x i8], ptr @str12, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2358, ptr %t2360, ptr %t2363, ptr %t2365, i32 1, i32 0)
  br label %bb452
bb452:
  %t2366 = load i32, ptr %t39
  %t2367 = load i32, ptr %t36
  %t2368 = load i32, ptr %t36
  %t2369 = load i32, ptr %t35
  %t2370 = getelementptr [49 x i8], ptr @str108, i32 0, i32 0
  %t2371 = alloca i32, i32 2
  ...
  %t2377 = getelementptr [3 x i8], ptr @str101, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2366, ptr %t2370, ptr %t2374, ptr %t2377, i32 2, i32 0)
  br label %bb453
bb453:
  %t2378 = load i32, ptr %t39
  %t2379 = getelementptr [49 x i8], ptr @str109, i32 0, i32 0
  %t2380 = alloca i32, i32 4
  %t2381 = getelementptr i32, ptr %t2380, i32 0
  store i32 5, ptr %t2381
  %t2382 = getelementptr i32, ptr %t2380, i32 1
  store i32 5, ptr %t2382
  %t2383 = getelementptr i32, ptr %t2380, i32 2
  store i32 5, ptr %t2383
  %t2384 = getelementptr i32, ptr %t2380, i32 3
  store i32 5, ptr %t2384
  %t2385 = alloca ptr, i32 6
  %t2386 = getelementptr ptr, ptr %t2385, i32 0
  store ptr %t2381, ptr %t2386
  %t2387 = getelementptr ptr, ptr %t2385, i32 1
  store ptr %t2382, ptr %t2387
  %t2388 = getelementptr ptr, ptr %t2385, i32 2
  store ptr %t24, ptr %t2388
  %t2389 = getelementptr ptr, ptr %t2385, i32 3
  store ptr %t2383, ptr %t2389
  %t2390 = getelementptr ptr, ptr %t2385, i32 4
  store ptr %t2384, ptr %t2390
  %t2391 = getelementptr ptr, ptr %t2385, i32 5
  store ptr %t24, ptr %t2391
  %t2392 = getelementptr [7 x i8], ptr @str4, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2378, ptr %t2379, ptr %t2385, ptr %t2392, i32 6, i32 0)
  br label %bb454
bb454:
  %t2393 = load i32, ptr %t39
  %t2394 = getelementptr [44 x i8], ptr @str110, i32 0, i32 0
  %t2395 = alloca i32, i32 8
  %t2396 = getelementptr i32, ptr %t2395, i32 0
  store i32 13, ptr %t2396
  %t2397 = getelementptr i32, ptr %t2395, i32 1
  store i32 13, ptr %t2397
  %t2398 = getelementptr i32, ptr %t2395, i32 2
  store i32 20, ptr %t2398
  %t2399 = getelementptr i32, ptr %t2395, i32 3
  store i32 20, ptr %t2399
  %t2400 = getelementptr i32, ptr %t2395, i32 4
  store i32 10, ptr %t2400
  %t2401 = getelementptr i32, ptr %t2395, i32 5
  store i32 10, ptr %t2401
  %t2402 = getelementptr i32, ptr %t2395, i32 6
  store i32 13, ptr %t2402
  %t2403 = getelementptr i32, ptr %t2395, i32 7
  store i32 13, ptr %t2403
  %t2404 = alloca ptr, i32 12
  %t2405 = getelementptr ptr, ptr %t2404, i32 0
  store ptr %t2396, ptr %t2405
  %t2406 = getelementptr ptr, ptr %t2404, i32 1
  store ptr %t2397, ptr %t2406
  %t2407 = getelementptr ptr, ptr %t2404, i32 2
  store ptr %t28, ptr %t2407
  %t2408 = getelementptr ptr, ptr %t2404, i32 3
  store ptr %t2398, ptr %t2408
  %t2409 = getelementptr ptr, ptr %t2404, i32 4
  store ptr %t2399, ptr %t2409
  %t2410 = getelementptr ptr, ptr %t2404, i32 5
  store ptr %t26, ptr %t2410
  %t2411 = getelementptr ptr, ptr %t2404, i32 6
  store ptr %t2400, ptr %t2411
  %t2412 = getelementptr ptr, ptr %t2404, i32 7
  store ptr %t2401, ptr %t2412
  %t2413 = getelementptr ptr, ptr %t2404, i32 8
  store ptr %t27, ptr %t2413
  %t2414 = getelementptr ptr, ptr %t2404, i32 9
  store ptr %t2402, ptr %t2414
  %t2415 = getelementptr ptr, ptr %t2404, i32 10
  store ptr %t2403, ptr %t2415
  %t2416 = getelementptr ptr, ptr %t2404, i32 11
  store ptr %t30, ptr %t2416
  %t2417 = getelementptr [13 x i8], ptr @str111, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t2393, ptr %t2394, ptr %t2404, ptr %t2417, i32 12, i32 0)
  br label %bb455
bb455:
  %t2418 = load i32, ptr %t39
  %t2419 = getelementptr [79 x i8], ptr @str112, i32 0, i32 0

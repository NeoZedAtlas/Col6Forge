...
bb259:
  ...
  %t1028 = getelementptr [49 x i8], ptr @str20, i32 0, i32 0
  ...
  %t1032 = alloca ptr, i32 2
  %t1033 = getelementptr ptr, ptr %t1032, i32 0
  store ptr %t1030, ptr %t1033
  %t1034 = getelementptr ptr, ptr %t1032, i32 1
  store ptr %t1031, ptr %t1034
  %t1035 = getelementptr [3 x i8], ptr @str21, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t1024, ptr %t1028, ptr %t1032, ptr %t1035, i32 2, i32 0)
  br label %bb260
bb260:
  %t1036 = load i32, ptr %t22
  %t1037 = getelementptr [49 x i8], ptr @str22, i32 0, i32 0
...
bb261:
  ...
  %t1052 = getelementptr [44 x i8], ptr @str23, i32 0, i32 0
  ...
  store ptr %t13, ptr %t1074
  %t1075 = getelementptr [13 x i8], ptr @str24, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t1051, ptr %t1052, ptr %t1062, ptr %t1075, i32 12, i32 0)
  br label %bb262
bb262:
  %t1076 = load i32, ptr %t22
  %t1077 = getelementptr [79 x i8], ptr @str25, i32 0, i32 0

...
bb110:
  ...
  call i32 @col6forge_write_v(i32 %t528, ptr %t532, ptr %t536, ptr %t539, i32 2, i32 0)
  br label %bb111
bb111:
  %t540 = load i32, ptr %t23
  %t541 = getelementptr [49 x i8], ptr @str22, i32 0, i32 0
  %t542 = alloca i32, i32 4

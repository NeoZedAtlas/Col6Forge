...
bb288:
  ...
  %t1111 = getelementptr [49 x i8], ptr @str22, i32 0, i32 0
  %t1112 = alloca i32, i32 2
  ...
  store ptr %t1114, ptr %t1117
  %t1118 = getelementptr [3 x i8], ptr @str23, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t1107, ptr %t1111, ptr %t1115, ptr %t1118, i32 2, i32 0)
  br label %bb289
bb289:
  %t1119 = load i32, ptr %t22
  %t1120 = getelementptr [49 x i8], ptr @str24, i32 0, i32 0
  ...
  store ptr %t7, ptr %t1132
  %t1133 = getelementptr [7 x i8], ptr @str4, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t1119, ptr %t1120, ptr %t1126, ptr %t1133, i32 6, i32 0)
  br label %bb290
bb290:
  %t1134 = load i32, ptr %t22
  %t1135 = getelementptr [44 x i8], ptr @str25, i32 0, i32 0
  %t1136 = alloca i32, i32 8
  %t1137 = getelementptr i32, ptr %t1136, i32 0
  store i32 13, ptr %t1137
  %t1138 = getelementptr i32, ptr %t1136, i32 1
  store i32 13, ptr %t1138
  %t1139 = getelementptr i32, ptr %t1136, i32 2
  store i32 20, ptr %t1139
  %t1140 = getelementptr i32, ptr %t1136, i32 3
  store i32 20, ptr %t1140
  %t1141 = getelementptr i32, ptr %t1136, i32 4
  store i32 10, ptr %t1141
  %t1142 = getelementptr i32, ptr %t1136, i32 5
  store i32 10, ptr %t1142
  %t1143 = getelementptr i32, ptr %t1136, i32 6
  store i32 13, ptr %t1143
  %t1144 = getelementptr i32, ptr %t1136, i32 7
  store i32 13, ptr %t1144
  %t1145 = alloca ptr, i32 12
  %t1146 = getelementptr ptr, ptr %t1145, i32 0
  store ptr %t1137, ptr %t1146
  %t1147 = getelementptr ptr, ptr %t1145, i32 1
  store ptr %t1138, ptr %t1147
  %t1148 = getelementptr ptr, ptr %t1145, i32 2
  store ptr %t11, ptr %t1148
  ...
  %t1151 = getelementptr ptr, ptr %t1145, i32 5
  store ptr %t9, ptr %t1151
  %t1152 = getelementptr ptr, ptr %t1145, i32 6
  store ptr %t1141, ptr %t1152
  %t1153 = getelementptr ptr, ptr %t1145, i32 7
  store ptr %t1142, ptr %t1153
  %t1154 = getelementptr ptr, ptr %t1145, i32 8
  store ptr %t10, ptr %t1154
  %t1155 = getelementptr ptr, ptr %t1145, i32 9
  store ptr %t1143, ptr %t1155
  %t1156 = getelementptr ptr, ptr %t1145, i32 10
  store ptr %t1144, ptr %t1156
  %t1157 = getelementptr ptr, ptr %t1145, i32 11
  store ptr %t13, ptr %t1157
  %t1158 = getelementptr [13 x i8], ptr @str26, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t1134, ptr %t1135, ptr %t1145, ptr %t1158, i32 12, i32 0)
  br label %bb291
bb291:
  %t1159 = load i32, ptr %t22
  %t1160 = getelementptr [79 x i8], ptr @str27, i32 0, i32 0

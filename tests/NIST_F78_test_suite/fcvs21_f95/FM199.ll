; ModuleID = 'col6forge'
source_filename = "tests/NIST_F78_test_suite\fcvs21_f95\FM199.f"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-gnu"
@fmt_fm199_90001 = private unnamed_addr constant [32 x i8] c"                         FM199\0A\00", align 1
@fmt_fm199_90000 = private unnamed_addr constant [43 x i8] c"                     END OF PROGRAM FM199\0A\00", align 1
@fmt_fm199_80000 = private unnamed_addr constant [23 x i8] c"     %5d      DELETED\0A\00", align 1
@fmt_fm199_80002 = private unnamed_addr constant [21 x i8] c"     %5d       PASS\0A\00", align 1
@fmt_fm199_80010 = private unnamed_addr constant [46 x i8] c"     %5d       FAIL          %6d         %6d\0A\00", align 1
@fmt_fm199_80012 = private unnamed_addr constant [40 x i8] c"     %5d       FAIL    %12.5E   %12.5E\0A\00", align 1
@fmt_fm199_80018 = private unnamed_addr constant [32 x i8] c"     %5d       FAIL  %14s %14s\0A\00", align 1
@fmt_fm199_90002 = private unnamed_addr constant [3 x i8] c"1\0A\00", align 1
@fmt_fm199_90004 = private unnamed_addr constant [3 x i8] c" \0A\00", align 1
@fmt_fm199_90006 = private unnamed_addr constant [47 x i8] c"           FORTRAN COMPILER VALIDATION SYSTEM\0A\00", align 1
@fmt_fm199_90008 = private unnamed_addr constant [35 x i8] c"                      VERSION 2.1\0A\00", align 1
@fmt_fm199_90010 = private unnamed_addr constant [49 x i8] c"         FOR OFFICIAL USE ONLY - COPYRIGHT 1978\0A\00", align 1
@fmt_fm199_90012 = private unnamed_addr constant [54 x i8] c"      TEST     PASS/FAIL     COMPUTED        CORRECT\0A\00", align 1
@fmt_fm199_90014 = private unnamed_addr constant [54 x i8] c"      ----------------------------------------------\0A\00", align 1
@fmt_fm199_90016 = private unnamed_addr constant [38 x i8] c"                   SUBSET LEVEL TEST\0A\00", align 1
@fmt_fm199_90020 = private unnamed_addr constant [38 x i8] c"                    %5d TESTS FAILED\0A\00", align 1
@fmt_fm199_90022 = private unnamed_addr constant [38 x i8] c"                    %5d TESTS PASSED\0A\00", align 1
@fmt_fm199_90024 = private unnamed_addr constant [39 x i8] c"                    %5d TESTS DELETED\0A\00", align 1
define void @fm199_() {
entry:
  %t0 = alloca i32
  %t1 = alloca i32
...
bb34:
  ...
  call i32 @f77_write_v(i32 %t67, ptr %t71, ptr %t75, ptr %t79, i32 3, i32 0)
  br label %L21
L21:
  br label %bb36
bb36:
...
bb66:
  ...
  call i32 @f77_write_v(i32 %t153, ptr %t157, ptr %t161, ptr %t165, i32 3, i32 0)
  br label %L41
L41:
  br label %bb68
bb68:
...
bb77:
  ...
  call i32 @f77_write_v(i32 %t175, ptr %t177, ptr %t179, ptr %t181, i32 1, i32 0)
  br label %bb78
bb78:
...
bb80:
  ...
  call i32 @f77_write_v(i32 %t187, ptr %t189, ptr %t191, ptr %t193, i32 1, i32 0)
  br label %bb81
bb81:
  br label %L51
L20040:
...
bb83:
  ...
  call i32 @f77_write_v(i32 %t196, ptr %t200, ptr %t204, ptr %t208, i32 3, i32 0)
  br label %L51
L51:
  br label %bb85
bb85:
...
bb99:
  ...
  call i32 @f77_write_v(i32 %t238, ptr %t242, ptr %t246, ptr %t250, i32 3, i32 0)
  br label %L61
L61:
  br label %bb101
bb101:
...
bb116:
  ...
  call i32 @f77_write_v(i32 %t281, ptr %t285, ptr %t289, ptr %t293, i32 3, i32 0)
  br label %L71
L71:
  br label %bb118
bb118:
...
bb169:
  ...
  call i32 @f77_write_v(i32 %t417, ptr %t421, ptr %t425, ptr %t429, i32 3, i32 0)
  br label %L101
L101:
  br label %bb171
bb171:
...
bb221:
  ...
  call i32 @f77_write_v(i32 %t742, ptr %t746, ptr %t750, ptr %t754, i32 3, i32 0)
  br label %L131
L131:
  br label %bb223
bb223:
...
bb237:
  ...
  call i32 @f77_write_v(i32 %t785, ptr %t789, ptr %t793, ptr %t797, i32 3, i32 0)
  br label %L141
L141:
  br label %bb239
bb239:
...
@str6 = private unnamed_addr constant [32 x i8] c"                         FM199\0A\00", align 1
...
@str14 = private unnamed_addr constant [43 x i8] c"                     END OF PROGRAM FM199\0A\00", align 1

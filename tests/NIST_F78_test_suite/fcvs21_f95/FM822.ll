...
bb22:
  ...
  %t340 = getelementptr [94 x i8], ptr @str7, i32 0, i32 0
...
bb29:
  ...
  %t358 = call double @tan(double %t357)
...
bb42:
  ...
  %t394 = call double @tan(double %t393)
...
bb54:
  ...
  %t430 = call double @tan(double %t429)
  store double %t430, ptr %t0
  %t431 = load double, ptr %t0
  %t432 = fadd double %t431, 5.0e-10
...
bb66:
  ...
  %t466 = fdiv double %t465, 4.0e0
  %t467 = call double @tan(double %t466)
  store double %t467, ptr %t0
  %t468 = load double, ptr %t0
  %t469 = fsub double %t468, 9.999999995e-1
...
L40040:
  ...
  %t473 = fsub double %t472, 1.000000001e0
...
bb77:
  store i32 5, ptr %t24
  %t502 = load double, ptr %t2
  %t503 = fmul double 5.0e0, %t502
  %t504 = fdiv double %t503, 4.0e0
  store double %t504, ptr %t1
  %t505 = load double, ptr %t1
  %t506 = call double @tan(double %t505)
...
bb89:
  store i32 6, ptr %t24
  %t541 = fsub double 0.0, 2.0e0
  %t542 = fdiv double %t541, 1.0e0
  store double %t542, ptr %t1
  %t543 = load double, ptr %t1
  %t544 = call double @tan(double %t543)
  store double %t544, ptr %t0
  %t545 = load double, ptr %t0
  %t546 = fsub double %t545, 2.185039862e0
...
L40060:
  ...
  %t550 = fsub double %t549, 2.185039865e0
...
bb101:
  store i32 7, ptr %t24
  %t579 = fdiv double 3.5e2, 1.0e2
  store double %t579, ptr %t1
  %t580 = load double, ptr %t1
  %t581 = call double @tan(double %t580)
  store double %t581, ptr %t0
  %t582 = load double, ptr %t0
  %t583 = fsub double %t582, 3.745856399e-1
...
L40070:
  ...
  %t587 = fsub double %t586, 3.745856404e-1
...
bb110:
  ...
  call i32 @col6forge_write_v(i32 %t602, ptr %t608, ptr %t611, ptr %t615, i32 3, i32 0)
  br label %L71
L71:
  br label %bb113
bb113:
  ...
  %t617 = call double @tan(double %t616)
  store double %t617, ptr %t0
  %t618 = load double, ptr %t0
  %t619 = fsub double %t618, 7.958289861e0
  %t620 = fcmp olt double %t619, 0.0
  br i1 %t620, label %L20080, label %arith_if_zero80
arith_if_zero80:
  %t621 = fcmp oeq double %t619, 0.0
  br i1 %t621, label %L10080, label %L40080
L40080:
  %t622 = load double, ptr %t0
  %t623 = fsub double %t622, 7.95828987e0
  %t624 = fcmp olt double %t623, 0.0
  br i1 %t624, label %L10080, label %arith_if_zero81
arith_if_zero81:
  %t625 = fcmp oeq double %t623, 0.0
  br i1 %t625, label %L10080, label %L20080
L10080:
...
bb125:
  ...
  %t652 = load double, ptr %t1
  %t653 = call double @tan(double %t652)
  store double %t653, ptr %t0
  %t654 = load double, ptr %t0
  %t655 = fadd double %t654, 2.559986981e2
  %t656 = fcmp olt double %t655, 0.0
  br i1 %t656, label %L20090, label %arith_if_zero82
arith_if_zero82:
  %t657 = fcmp oeq double %t655, 0.0
  br i1 %t657, label %L10090, label %L40090
L40090:
  %t658 = load double, ptr %t0
  %t659 = fadd double %t658, 2.559986977e2
  %t660 = fcmp olt double %t659, 0.0
  br i1 %t660, label %L10090, label %arith_if_zero83
arith_if_zero83:
  %t661 = fcmp oeq double %t659, 0.0
  br i1 %t661, label %L10090, label %L20090
L10090:
...
L20090:
  ...
  %t673 = add i32 %t672, 1
  store i32 %t673, ptr %t15
  br label %bb134
bb134:
  %t674 = fsub double 0.0, 2.5599869791534212e2
  store double %t674, ptr %t3
  %t675 = load i32, ptr %t23
  %t676 = load i32, ptr %t24
  %t677 = load double, ptr %t0
  %t678 = load double, ptr %t3
  %t679 = call ptr @col6forge_fmt_d(i32 17, i32 10, i32 0, i32 0, i32 0, double %t677)
  ...
  call i32 @col6forge_write_v(i32 %t675, ptr %t681, ptr %t684, ptr %t688, i32 3, i32 0)
  br label %L91
L91:
  br label %bb137
bb137:
  store i32 10, ptr %t24
  %t689 = load double, ptr %t2
  %t690 = fmul double 3.0e0, %t689
  %t691 = fdiv double %t690, 2.0e0
  %t692 = fdiv double 1.0e0, 1.024e3
  %t693 = fsub double %t691, %t692
  %t694 = call double @tan(double %t693)
  store double %t694, ptr %t0
  %t695 = load double, ptr %t0
  %t696 = fsub double %t695, 1.023999674e3
...
L40100:
  ...
  %t700 = fsub double %t699, 1.023999675e3
...
bb148:
  ...
  %t729 = load double, ptr %t2
  %t730 = fmul double 3.0e0, %t729
  %t731 = fdiv double %t730, 2.0e0
  %t732 = fdiv double 1.0e0, 6.4e1
  %t733 = fadd double %t731, %t732
  store double %t733, ptr %t1
  %t734 = load double, ptr %t1
  %t735 = call double @tan(double %t734)
  store double %t735, ptr %t0
  %t736 = load double, ptr %t0
  %t737 = fadd double %t736, 6.399479162e1
  %t738 = fcmp olt double %t737, 0.0
  br i1 %t738, label %L20110, label %arith_if_zero86
arith_if_zero86:
  %t739 = fcmp oeq double %t737, 0.0
  br i1 %t739, label %L10110, label %L40110
L40110:
  %t740 = load double, ptr %t0
  %t741 = fadd double %t740, 6.399479155e1
  %t742 = fcmp olt double %t741, 0.0
  br i1 %t742, label %L10110, label %arith_if_zero87
arith_if_zero87:
  %t743 = fcmp oeq double %t741, 0.0
  br i1 %t743, label %L10110, label %L20110
L10110:
  %t744 = load i32, ptr %t14
  %t745 = add i32 %t744, 1
  store i32 %t745, ptr %t14
  br label %bb154
bb154:
...
L20110:
  ...
  br label %bb157
bb157:
  %t756 = fsub double 0.0, 6.3994791581893644e1
  store double %t756, ptr %t3
  %t757 = load i32, ptr %t23
  %t758 = load i32, ptr %t24
  %t759 = load double, ptr %t0
  %t760 = load double, ptr %t3
  %t761 = call ptr @col6forge_fmt_d(i32 17, i32 10, i32 0, i32 0, i32 0, double %t759)
  ...
  call i32 @col6forge_write_v(i32 %t757, ptr %t763, ptr %t766, ptr %t770, i32 3, i32 0)
  br label %L111
L111:
  br label %bb160
bb160:
  store i32 12, ptr %t24
  %t771 = call double @tan(double 2.0e3)
  store double %t771, ptr %t0
  %t772 = load double, ptr %t0
  %t773 = fadd double %t772, 2.53099833e0
...
L40120:
  ...
  %t777 = fadd double %t776, 2.530998326e0
...
L20120:
  ...
  %t791 = add i32 %t790, 1
  store i32 %t791, ptr %t15
  br label %bb168
bb168:
  %t792 = fsub double 0.0, 2.530998328093341e0
  store double %t792, ptr %t3
  %t793 = load i32, ptr %t23
  %t794 = load i32, ptr %t24
  %t795 = load double, ptr %t0
  %t796 = load double, ptr %t3
...
bb171:
  ...
  %t807 = load double, ptr %t2
  %t808 = fmul double %t807, 1.0e-15
  store double %t808, ptr %t1
  %t809 = load double, ptr %t1
  %t810 = call double @tan(double %t809)
  store double %t810, ptr %t0
  %t811 = load double, ptr %t0
  %t812 = fsub double %t811, 3.141592652e-15
...
L40130:
  ...
  %t816 = fsub double %t815, 3.141592655e-15
...
bb180:
  ...
  %t834 = load double, ptr %t3
  %t835 = call ptr @col6forge_fmt_d(i32 17, i32 10, i32 0, i32 0, i32 0, double %t833)
  ...
  %t844 = getelementptr [4 x i8], ptr @str15, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t831, ptr %t837, ptr %t840, ptr %t844, i32 3, i32 0)
  br label %L131
L131:
  br label %bb183
bb183:
  store i32 14, ptr %t24
  %t845 = load double, ptr %t2
  %t846 = fdiv double %t845, 6.0e0
  %t847 = call double @tan(double %t846)
  %t848 = load double, ptr %t2
  %t849 = fdiv double %t848, 6.0e0
  %t850 = call double @tan(double %t849)
  %t851 = fmul double %t847, %t850
  store double %t851, ptr %t0
  %t852 = load double, ptr %t0
  %t853 = fsub double %t852, 3.333333331e-1
  %t854 = fcmp olt double %t853, 0.0
  br i1 %t854, label %L20140, label %arith_if_zero92
arith_if_zero92:
  %t855 = fcmp oeq double %t853, 0.0
  br i1 %t855, label %L10140, label %L40140
L40140:
  %t856 = load double, ptr %t0
  %t857 = fsub double %t856, 3.333333335e-1
  %t858 = fcmp olt double %t857, 0.0
  br i1 %t858, label %L10140, label %arith_if_zero93
arith_if_zero93:
  %t859 = fcmp oeq double %t857, 0.0
  br i1 %t859, label %L10140, label %L20140
L10140:
  %t860 = load i32, ptr %t14
  %t861 = add i32 %t860, 1
  store i32 %t861, ptr %t14
  br label %bb188
bb188:
  %t862 = load i32, ptr %t23
  %t863 = load i32, ptr %t24
  %t864 = getelementptr [19 x i8], ptr @str13, i32 0, i32 0
...
bb191:
  ...
  %t875 = load double, ptr %t3
  %t876 = call ptr @col6forge_fmt_d(i32 17, i32 10, i32 0, i32 0, i32 0, double %t874)
  %t877 = call ptr @col6forge_fmt_d(i32 17, i32 10, i32 0, i32 0, i32 0, double %t875)
  %t878 = getelementptr [79 x i8], ptr @str14, i32 0, i32 0
  ...
  call i32 @col6forge_write_v(i32 %t872, ptr %t878, ptr %t881, ptr %t885, i32 3, i32 0)
  br label %L141
L141:
  br label %bb194
bb194:
...
bb198:
  ...
  %t900 = load i32, ptr %t14
  %t901 = getelementptr [40 x i8], ptr @str16, i32 0, i32 0
  ...
  br label %bb199
bb199:
  %t907 = load i32, ptr %t22
  %t908 = load i32, ptr %t15
  %t909 = getelementptr [40 x i8], ptr @str17, i32 0, i32 0
...
bb200:
  ...
  %t917 = getelementptr [41 x i8], ptr @str18, i32 0, i32 0
...
bb201:
  ...
  %t925 = getelementptr [52 x i8], ptr @str19, i32 0, i32 0
  ...
  br label %bb202
bb202:
  %t931 = load i32, ptr %t22
  %t932 = load i32, ptr %t19
  %t933 = load i32, ptr %t19
  %t934 = load i32, ptr %t18
  %t935 = getelementptr [49 x i8], ptr @str20, i32 0, i32 0
  ...
  %t942 = getelementptr [3 x i8], ptr @str21, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t931, ptr %t935, ptr %t939, ptr %t942, i32 2, i32 0)
  br label %bb203
bb203:
  %t943 = load i32, ptr %t22
  %t944 = getelementptr [49 x i8], ptr @str22, i32 0, i32 0
...
bb204:
  ...
  %t959 = getelementptr [44 x i8], ptr @str23, i32 0, i32 0
  ...
  store ptr %t13, ptr %t981
  %t982 = getelementptr [13 x i8], ptr @str24, i32 0, i32 0
  call i32 @col6forge_write_v(i32 %t958, ptr %t959, ptr %t969, ptr %t982, i32 12, i32 0)
  br label %bb205
bb205:
  %t983 = load i32, ptr %t22
  %t984 = getelementptr [79 x i8], ptr @str25, i32 0, i32 0

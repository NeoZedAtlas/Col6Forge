...
pub const parseProgramWithDiagnostics = frontend.parser.parseProgramWithDiagnostics;
pub const analyzeProgram = sema.analyzeProgram;
pub const analyzeProgramWithKnownAndOptionsAndDiagnostics = sema.analyzeProgramWithKnownAndOptionsAndDiagnostics;
